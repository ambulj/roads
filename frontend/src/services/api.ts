...
// Fallback seed data matching Chennai transit corridors enriched with POI prioritization (1 of each hazard defect type)
export const INITIAL_CLUSTERS: HazardCluster[] = [
  {
    ...
    lat: 12.9516,
    lng: 80.1462,
    before_image_url: "https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    defect_type: "D20",
    defect_name: "Alligator Fatigue Crack",
    severity_level: "high",
    rpi_score: 76.2,
    rpi_boosted: 86.2,
    ...
    lat: 13.0418,
    lng: 80.2341,
    before_image_url: "https://images.unsplash.com/photo-1578632767115-351597cf2477?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    defect_type: "D10",
    defect_name: "Transverse Thermal Crack",
    severity_level: "high",
    rpi_score: 74.5,
    rpi_boosted: 82.5,
    poi_boost_applied: 8,
    ...
    lat: 12.9719,
    lng: 80.2500,
    before_image_url: "https://images.unsplash.com/photo-1584463699039-385038fef3e3?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    defect_name: "IS:1726 Open Manhole Void",
    severity_level: "critical",
    rpi_score: 91.0,
    rpi_boosted: 100.0,
    poi_boost_applied: 10,
  ...
  },
  {
    ...
    defect_name: "Monsoon Hydro Cavity Basin",
    severity_level: "high",
    rpi_score: 82.0,
    rpi_boosted: 97.0,
    poi_boost_applied: 15,
    ...
    sla_hours: 24,
    sla_deadline_iso: new Date(Date.now() + 18 * 3600 * 1000).toISOString(),
    status: "open",
    lat: 12.9815,
    lng: 80.2180,
    before_image_url: "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    defect_name: "Faded Pedestrian Crossing (IRC:35)",
    severity_level: "medium",
    rpi_score: 70.0,
    rpi_boosted: 85.0,
    poi_boost_applied: 15,
    poi_tags: [{ name: "SRM Medical College", category: "hospital" }],
    pass_count: 6,
    road_name: "Chromepet Govt Hospital Zone",
    classification: "National Highway (NH)",
    ...
    sla_hours: 48,
    sla_deadline_iso: new Date(Date.now() + 32 * 3600 * 1000).toISOString(),
    status: "open",
    lat: 12.8231,
    lng: 80.0442,
    before_image_url: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=600&auto=format&fit=crop&q=80",
  ...
  },
  {
    ...
    defect_name: "Missing Median Barrier Segment",
    severity_level: "medium",
    rpi_score: 65.0,
    rpi_boosted: 80.0,
    poi_boost_applied: 15,
    ...
    pass_count: 3,
    road_name: "Anna Salai (Mount Road CBD)",
    classification: "Major Arterial",
    ...
    sla_hours: 48,
    sla_deadline_iso: new Date(Date.now() + 40 * 3600 * 1000).toISOString(),
    status: "assigned",
    lat: 13.0604,
    lng: 80.2496,
    before_image_url: "https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?w=600&auto=format&fit=crop&q=80",
...
export const INITIAL_INCIDENTS: TrafficIncident[] = [
  ...
  },
  {
    ...
    vehicle_class: "Commercial Sedan",
  ...
  },
  {
    ...
    status: "ACTIVE_ALERT",
    mva_section: "IRC:35 & CMVR Rule 138 (School Zone Pedestrian Safety)",
    fine_amount_inr: 2500,
    description: "School children crossing alert: Vehicle failed to yield right-of-way in school pedestrian zone."
  },
  {
    id: "inc-004",
  ...
  },
  {
    ...
    plate_number: undefined,
    vehicle_class: "Exposed Storm Drain Void (Dia 65cm)",
  ...
  },
  {
    ...
    vehicle_class: "Private Compact SUV",
    target_speed_kmh: 0,
    is_intercepted: true,
    echallan_issued: true,
...
class ApiService {
  ...
  async lookupRTORegistration(plateNumber: string): Promise<any> {
    try {
      const res = await fetch(`${API_BASE}/traffic/rto/lookup/${encodeURIComponent(plateNumber)}`, {
        headers: this.getAuthHeaders()
      });
      if (res.ok) return await res.json();
    } catch (e) {
      console.warn("Failed to lookup RTO registration:", e);
    }
    return null;
  }

  async flagVehicleCompliance(plateNumber: string, flagReason: string, notes?: string): Promise<any> {
    try {
      const res = await fetch(`${API_BASE}/traffic/rto/flag-compliance`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...this.getAuthHeaders()
      ...
      console.warn("Failed to flag vehicle compliance:", e);
    }
    return { success: false };
  }
