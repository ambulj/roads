...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "header.sensorFusion": "Sensor Fusion Engine",
    "header.sensorFusionSub": "AIS-140 & RTSP Ingest Pipeline",
    "header.pdfSummons": "1-Click Notice Export",
    "header.pdfSummonsSub": "Contractor liquidated damages notice draft",
    ...
    "fleet.imuSensors": "5Hz Road Vibration Sensor (Accelerometer)",
    ...
    // Road Memory
    "memory.title": "Road Memory & Historical Pavement Degradation",
    "memory.subtitle": "Autonomous tracking of road distress growth over time using multi-bus telemetry",

    // Full Lifecycle Simulation
    "lifecycle.title": "Autonomous Road Defect Lifecycle Simulation",
    "lifecycle.subtitle": "Experience the complete zero-human-paperwork workflow from detection to verification",
    ...
    "lifecycle.step1": "1. Multi-Modal Vision & Telemetry Ingest",
    "lifecycle.step2": "2. Multi-Bus Spatial Consensus & Coordinate Clustering",
    "lifecycle.step3": "3. Automated CAD Work Order Generation",
    ...
    "analytics.contractorDebarment": "Contractor SLA & Debarment Risk"
  },
  hi: {
    // Navigation & Layout
    ...
    "header.sensorFusion": "सेंसर फ्यूज़न इंजन",
    "header.sensorFusionSub": "AIS-140 एवं RTSP इनपुट पाइपलाइन",
    "header.pdfSummons": "1-क्लिक नोटिस निर्यात",
    "header.pdfSummonsSub": "ठेकेदार जुर्माना एवं नोटिस ड्राफ्ट",
    ...
    "ui.rpi": "जोखिम प्राथमिकता सूचकांक",
    ...
    "fleet.imuSensors": "5Hz सड़क कंपन सेंसर (एक्सेलेरोमीटर)",
  ...
  ta: {
    ...
    "header.sensorFusion": "சென்சார் இணைப்பு என்ஜின்",
    "header.sensorFusionSub": "AIS-140 & RTSP தரவு செயலாக்கம்",
    "header.pdfSummons": "1-கிளிக் நோட்டீஸ் ஏற்றுமதி",
    "header.pdfSummonsSub": "ஒப்பந்ததாரர் அபராத நோட்டீஸ் வரைவு",
    ...
    "ui.rpi": "முன்னுரிமை ஆபத்து குறியீடு",
    ...
    "fleet.imuSensors": "5Hz சாலை அதிர்வு சென்சார் (முடுக்கமானி)",
