        ...
        {activeTab === 'sla' ? (
          ...
          <>
            ...
            <div className="p-4 sm:p-5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 font-mono text-[10px] font-bold border border-emerald-200 dark:border-emerald-800">
                ...
                <div className="flex items-center gap-3 w-full lg:w-auto">
                  <button
                    ...
                    className="flex-1 lg:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs transition active:scale-95 disabled:opacity-60 cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mt-4 pt-3 border-t border-slate-200 dark:border-slate-800 text-[11px] font-mono">
                <div className={`p-2 rounded-lg border flex items-center gap-2 transition ${
                  drillStep === 1 
                  ...
                  <span className="w-5 h-5 rounded-md bg-blue-600 text-white flex items-center justify-center font-bold text-[10px] shrink-0">1</span>
                  <span className="truncate">{t("lifecycle.step1", "1. AI + IMU Shock Detection")}</span>
                </div>

                <div className={`p-2 rounded-lg border flex items-center gap-2 transition ${
                  drillStep === 2 
                    ? 'bg-amber-50 dark:bg-amber-950/60 border-amber-400 text-amber-800 dark:text-amber-200 font-bold' 
                    : 'bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400'
                }`}>
                  <span className="w-5 h-5 rounded-md bg-amber-600 text-white flex items-center justify-center font-bold text-[10px] shrink-0">2</span>
                ...
                <div className={`p-2 rounded-lg border flex items-center gap-2 transition ${
                  ...
                  <span className="w-5 h-5 rounded-md bg-purple-600 text-white flex items-center justify-center font-bold text-[10px] shrink-0">3</span>
                ...
                <div className={`p-2 rounded-lg border flex items-center gap-2 transition ${
                  ...
                  <span className="w-5 h-5 rounded-md bg-emerald-600 text-white flex items-center justify-center font-bold text-[10px] shrink-0">4</span>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold text-amber-600 dark:text-amber-400 font-mono mt-0.5">{openCount}</div>
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 font-mono mt-0.5">{inProgressCount}</div>
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 font-mono mt-0.5">₹{totalBudget.toLocaleString()}</div>
            ...
            <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full h-9 pl-9 pr-3 rounded-lg bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-700 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 outline-none focus:border-blue-500 transition"
                />
              </div>
